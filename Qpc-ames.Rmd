...
myI = traitNames[6]
myM=2704
Qxpcames <- function(myI, myM = 2704, gwasPrefix = 'data/281_gwas_results/ldfiltered.', sigPrefix='data/281_gwas_results/sigSnps.'){
#read in data
gwasHits = read.table(paste(gwasPrefix,myI,'assoc.txt',sep=""), stringsAsFactors=F)
