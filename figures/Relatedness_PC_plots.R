...
myK = read.table('../data/All_240.nomaf.nomissing.K')
...
plot(fgmerge$X1, fgmerge$X2, col = as.factor(fgmerge$Subpopulation),
     ...
     xaxt = "n", xlim = c(-0.18,0.18), ylim = c(-0.25,0.12))
...
legend("bottomright", nicepops, bty="n", pch=1, pt.lwd=2, col = palette(), cex = 1.5)
...
axis(1, lwd=2, cex.axis=1.5)
axis(2, lwd=2, cex.axis=1.5, las=2)
legend('bottomright',c('Ames panel','GWAS panel'),pch=1, pt.lwd=2, col = c(colAmes, col282), cex=1.5, bty="n")
...
legend('bottomright',c('European Landraces','GWAS panel'),pch=1, pt.lwd=2, col = c(colDent,col282), cex=1.5, bty="n")
