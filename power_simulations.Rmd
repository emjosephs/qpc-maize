...
ceuroOut_power01 = lapply(1:200,function(x){Qpceuro(x, myM = 906, sigPrefix = 'data/simFiles/powerSimAlleles.0.01.table.', gwasPrefix= 'data/simFiles/ldfiltered.euro.assoc.', mysigma = euro282, mypcmax = pcmax, myLambda = condEig$values, myU = condEig$vectors, tailCutoff=1, vapcs = 453)})
save(ceuroOut_power01, file='data/simFiles/ceuroOut_200_power01') 

ceuroOut_power05 = lapply(1:200,function(x){Qpceuro(x, myM = 906, sigPrefix = 'data/simFiles/powerSimAlleles.0.05.table.', gwasPrefix= 'data/simFiles/ldfiltered.euro.assoc.', mysigma = euro282, mypcmax = pcmax, myLambda = condEig$values, myU = condEig$vectors, tailCutoff=1, vapcs = 453)})
save(ceuroOut_power05, file='data/simFiles/ceuroOut_200_power05') 

ceuroOut_power005 = lapply(1:200,function(x){Qpceuro(x, myM = 906, sigPrefix = 'data/simFiles/powerSimAlleles.0.005.table.', gwasPrefix= 'data/simFiles/ldfiltered.euro.assoc.', mysigma = euro282, mypcmax = pcmax, myLambda = condEig$values, myU = condEig$vectors, tailCutoff=1, vapcs = 453)})
